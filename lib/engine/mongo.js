...
var import_first = __toESM(require("../rules/first"));
var import_last = __toESM(require("../rules/last"));
var import_pop = __toESM(require("../rules/pop"));
...
mongo.append2(import_first.default);
mongo.append2(import_last.default);
mongo.append2(import_pop.default);
